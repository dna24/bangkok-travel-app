...
const SelectPlaceEdit = ({ visible, setVisible, setPlanPlaces, planPlaces = [] }) => {
    ...
    const addPlaceToPlan = (placeId, placeName) => {
        ...
        setPlanPlaces(prevPlaces => [
            ...prevPlaces, 
            { place_id: placeId, placeDetails: { place_name: placeName } }
        ]);        
        setVisible(false);
    };
...
export default SelectPlaceEdit;
